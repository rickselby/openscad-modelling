...
overhang = 16;
// The angle of the angled supports
angle = 8;
// Gap added to card with to give width of holder
card_gap = 5;
// Thickness of support bars
bar_thickness = 2;
// Gap to allow top/bottom to clip together
support_gap = 0.25;
// Gap to allow clips to clip together
clip_card_gap = 0.25;
// Distance between top and bottom if printing both
both_gap = 10;
...
// Offset of angled Support (1/6th from 1/2 = 1/3rd!)
